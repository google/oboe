...
Java_com_android_oboe_powerplay_engine_PowerPlayAudioPlayer_setupAudioStreamNative(
        JNIEnv *env,
        jobject,
        jint channels
) {
...
Java_com_android_oboe_powerplay_engine_PowerPlayAudioPlayer_startAudioStreamNative(
        JNIEnv *,
        jobject
) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_android_oboe_powerplay_engine_PowerPlayAudioPlayer_teardownAudioStreamNative(
        JNIEnv *,
        jobject
) {
 ...
 */
JNIEXPORT void JNICALL Java_com_android_oboe_powerplay_engine_PowerPlayAudioPlayer_loadAssetNative(
        JNIEnv *env,
        jobject,
 ...
 */
JNIEXPORT void JNICALL Java_com_android_oboe_powerplay_engine_PowerPlayAudioPlayer_unloadAssetsNative(
        JNIEnv *env,
        jobject
) {
...
Java_com_android_oboe_powerplay_engine_PowerPlayAudioPlayer_getOutputResetNative(
        JNIEnv *,
        jobject
) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_android_oboe_powerplay_engine_PowerPlayAudioPlayer_clearOutputResetNative(
        JNIEnv *,
        jobject
) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_android_oboe_powerplay_engine_PowerPlayAudioPlayer_startPlayingNative(JNIEnv *env, jobject,
                                                                               jint index,
                                                                               jint offload) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_android_oboe_powerplay_engine_PowerPlayAudioPlayer_stopPlayingNative(JNIEnv *env, jobject,
                                                                              jint index) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_android_oboe_powerplay_engine_PowerPlayAudioPlayer_setLoopingNative(JNIEnv *env, jobject,
                                                                             jint index,
                                                                             jboolean looping) {
