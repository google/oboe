...
void AudioWorkloadTest::SynthWorkload::onCallback(double workload) {
 ...
 * @param numFrames
 */
void AudioWorkloadTest::SynthWorkload::renderStereo(float *buffer, int numFrames) {
    if (buffer == nullptr) {
...
AudioWorkloadTest::SynthWorkload::SynthWorkload(int onFrames, int offFrames) {
